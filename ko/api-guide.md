...
Object | [validation](#validation_pos) | API |  | Y |  | api의 검증 정보
...
타입 | 필드명(경로명) | 해당하는 scenarioType | 할당 가능한 값 | 필수 여부 | 기본값 | 필드 설명
---|---|---|---|---|---|---
Object | [textValidation](#text_validation_pos) | API |  | N |  | 문자열 검증 정보
...
List \<Object\> | [textValidationInfos](#text_validation_info_pos) | API | | N |  | 문자열 검증정보

#text_validation_info_pos
